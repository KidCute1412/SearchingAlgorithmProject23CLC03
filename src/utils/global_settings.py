...
def custom_map_data():
    ...
    "0101111111111111111111111111110",
    "0101000000000000000100000000010",
    "0111011111111101111111111111110",
    "0100000001000101000101000001000",
    "0111111111011101111101111111110",
    "0000000100010000000100000000010",
    "0111111111111111111101111101110",
    "0001010000000001000001000100000",
    "1111011111011111011111011111110",
    "0100000001010000000000010000010",
    "0111111111011111111111110111111",
    "0100000000000000000001010100000",
    "0111111111011111111111011111110",
    "0000000001010001000001010000010",
    "0111111111110111011111010111110",
    "0100000000000000010001000100000",
    "0111111111111111111101111101110",
    ...
    for i in range(MAP_ROWS): map_data[i][0:31] = string_map[i]
    map_data[9][0] = 'S'
    map_data[11][30] = 'E'
    global CURRENT_MAP 
    CURRENT_MAP = map_data
