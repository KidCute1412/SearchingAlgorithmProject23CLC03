...
WALL_COLOR = (139, 69, 19) #(100, 255, 255)   # Wall color
START_COLOR = (102, 255, 168)    # Start point color
END_COLOR =   (255, 255, 0)     # End point color
PATH_COLOR = (255, 255, 255)   # Path color
MEDIUM_COLOR = (255, 200, 100)
HARD_COLOR = (255, 0, 0)
VISITED_COLOR = (100, 180, 255)  # Visited cell color
FOUND_COLOR = (200, 160, 255)# Found path color
...
def custom_map_data():
    map_data = [['1' for _ in range(MAP_COLS)] for _ in range(MAP_ROWS)]
    string_map = [
    "1S11111111111111111111111111111",
    "1111111111111111111111111111111",
    "1111111111111111111111111111111",
    "1111111111111111111111111111111",
    "1121111111111111111111111111111",
    "1233E11111111111111111111111111",
    "1111111111111111111111111111111",
    "1111111111111111111111111111111",
    "1111111111111111111111111111111",
    "1111111111111111111111111111111",
